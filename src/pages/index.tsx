        ...
        <div className="border border-white relative flex flex-col w-full rounded-lg">
          ...
          <button
            ...
            <div className="text-center mt-12">
              <h3 className="capitalize text-4xl font-semibold mb-2">
                {session?.user?.name}
              </h3>
              ...
              <div className="mb-2 mt-10">
                You logged in using &nbsp;
                <span className="capitalize bg-blue-700 text-white px-4 py-1 ml-2 font-bold italix text-lg rounded-md">
              ...
              <div className="flex flex-wrap justify-center">
                <div className="w-full px-4">
                  ...
                  <div className="mt-6 flex items-center justify-center gap-2">
                    Source code here : &nbsp;
                    <a
                      href="https://github.com/abhiinavgupta/Authentification-page-NextjS-Typescript"
                      target="_blank"
                  ...
                  <div className="flex justify-center gap-4  mt-4 pt-6 text-3xl ">
                    <a
                      href="https://github.com/abhiinavgupta"
                      target="_blank"
                    ...
                    <a
                      href="https://www.instagram.com/abhiiinavgupta/"
                      target="_blank"
                      className="hover:scale-125 transition ease-in-out"
                    >
                      <FaInstagram />
                    ...
                    <a
                      href="https://www.facebook.com/abhinav.gupta.7127/"
                      target="_blank"
                      className="hover:scale-125 transition ease-in-out"
                    >
                      <FaFacebook />
                    ...
                    <a
                      href="https://www.linkedin.com/in/abhinav-gupta-a07b93219/"
                      target="_blank"
                      className="hover:scale-125 transition ease-in-out"
                    >
                      <FaLinkedin />
                    ...
                    <a
                      href="https://www.udemy.com/user/abhi-nav-gupta/"
                      target="_blank"
                      className="hover:scale-125 transition ease-in-out"
                    >
                      <SiUdemy />
